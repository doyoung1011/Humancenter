...
DOCUMENT_FILE = BASE_DIR / 'util.py' # 경로 합치기 
...
# 원하는 필드만 업데이트 
@router.get('/es/crud/update/field')
def update_documet(id,price:int,rating:float):
    result={}
    try:
       result=es.update(
            index='computer',
